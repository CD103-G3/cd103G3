...
(1, 0, '日食小雞', 'chickAchievement (1).png', 0, 1),
(2, 20, '日食初心者', 'chickAchievement (2).png', 20, 1),
(3, 40, '日食常客', 'chickAchievement (3).png', 40, 1),
(4, 80, '日食老顧客', 'chickAchievement (4).png', 80, 1),
(5, 200, '日食VIP', 'chickAchievement (5).png', 200, 1),
(6, 300, '日食超級VIP', 'index_181018-03.png', 300, 1);
...
(18, '想吃是吃，日食餐廳!', 8, 'dayCook01', '2018-11-26', '2018-12-01', 30, 2, 0.4, 60);
...
(1, 'ke', 'ke', 'ke', 'a@a.com', NULL, 'logo3.png', 999769, 50),
(3, 'ms0223900', '1234', 'Penguin', NULL, NULL, 'logo3.png', 0, 32),
...
(9, 'dayCook02', '1234', '日食腦闆', NULL, NULL, 'logo3.png', 1064, 9999),
(10, 'dayCook03', '1234', '日食員工', NULL, NULL, 'logo3.png', 1064, 9999),
(11, 'g111', '1234', '1234', '1234@fff.com', NULL, 'logo3.png', 0, 5),
(12, 'g1112', '1234', '111', '111@lddl.com', NULL, 'logo3.png', 0, 0),
(18, 'aadadad', '1234', '111', 'asdasd@asdasd.com', NULL, 'logo3.png', 50, 0),
...
(19, 'asdaaaa', '1234', 'asd', 'asdasd@asdasd.com', NULL, 'logo3.png', 0, 5);
...
(2, 2, '1997-10-04 22:23:00', '1997-10-04 22:25:00', 'ing', 23, 0, ''),
(3, 8, '1997-10-04 22:23:00', '1997-10-04 22:23:00', 'ing', 350, 0, ''),
(4, 4, '2018-11-21 11:57:45', '2018-11-21 12:12:45', 'ing', 920, 0, '4.png'),
(5, 11, '2018-11-21 11:57:45', '2018-11-21 12:12:45', 'ing', 920, 0, '4.png'),
(6, 3, '2018-11-21 11:57:45', '2018-11-21 12:12:45', 'ing', 920, 0, '4.png'),
(7, 3, '2018-11-21 13:47:01', '2018-11-21 14:02:01', 'ing', 224, 0, '7.png'),
(8, 3, '2018-11-21 13:48:11', '2018-11-21 14:03:11', 'ing', 246, 0, '8.png'),
(9, 3, '2018-11-21 13:48:11', '2018-11-21 14:03:11', 'ing', 246, 0, '8.png'),
(10, 19, '2018-11-21 14:42:15', '2018-11-21 14:42:15', 'ing', 246, 0, '8.png'),
(11, 19, '2018-11-21 14:44:41', '2018-11-21 15:29:41', 'ing', 1040, 0, '11.png');
...
(18, 3, 13, 'AABBCC', '2018-11-21', 0),
(19, 4, 13, '太感動了，我一定要帶妹妹來吃!!阿~我沒有妹妹T_T', '2018-11-21', 0),
(45, 8, 14, '安安\n', '2018-11-21', 0),
...
(35, NULL, 25, '節目中誇張的好吃表情真的不是騙人的，香氣咬兩下馬上在嘴中化開，甜味慢慢的滑入喉嚨，這味道真是太誘人了~', '2018-11-21', 0),
(36, NULL, 25, '救命啊~我從沒吃過這麼好吃的食物!!!', '2018-11-21', 0),
(37, NULL, 25, '為什麼要讓我吃到一個這麼好的食物? 如果我以後吃不到怎麼辦啊~', '2018-11-21', 0),
(38, NULL, 25, '感謝父母讓我來這世上~', '2018-11-21', 0),
(39, NULL, 25, '為什麼要讓我吃到一個這麼好的食物? 如果我以後吃不到怎麼辦啊~', '2018-11-21', 0),
(40, 3, 25, '感謝父母讓我來這世上~', '2018-11-21', 0),
(41, 8, 10, '了不起，好吃!!', '2018-11-21', 0),
(42, 8, 3, '節目中誇張的好吃表情真的不是騙人的，香氣咬兩下馬上在嘴中化開，甜味慢慢的滑入喉嚨，這味道真是太誘人了~', '2018-11-21', 0),
(43, 8, 3, '為什麼要讓我吃到一個這麼好的食物? 如果我以後吃不到怎麼辦啊~', '2018-11-21', 0),
(44, 3, 60, '救命啊~我從沒吃過這麼好吃的食物!!!', '2018-11-21', 0);
...
(9, 19, '太感動了，我一定要帶妹妹來吃!!阿~我沒有妹妹T_T', '2018-11-21', 'pass'),
(10, 18, 'AABBCC', '2018-11-21', 'pass'),
(11, 45, '安安\n', '2018-11-21', 'pass');
...
--
ALTER TABLE `achievement`
  MODIFY `achievement_No` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `member`
  MODIFY `member_No` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `membergroupon`
  MODIFY `memberGrouponList_No` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- 使用資料表 AUTO_INCREMENT `membergrouponmeallist`
--
ALTER TABLE `membergrouponmeallist`
  MODIFY `memberGrouponMealList_No` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=330;

--
-- 使用資料表 AUTO_INCREMENT `memberorder`
--
ALTER TABLE `memberorder`
  MODIFY `memOrder_No` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- 使用資料表 AUTO_INCREMENT `memberorderlist`
--
ALTER TABLE `memberorderlist`
  MODIFY `memOrderList_No` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- 使用資料表 AUTO_INCREMENT `message`
--
ALTER TABLE `message`
  MODIFY `message_No` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;

--
-- 使用資料表 AUTO_INCREMENT `messagereport`
--
ALTER TABLE `messagereport`
  MODIFY `report_No` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
COMMIT;
